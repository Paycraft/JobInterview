        ...
        items(properties) { property ->
            Row {
                ...
                if (!property.isFavorite) {
                    Icon(painter = painterResource(id = R.drawable.fav_border), contentDescription = "favourite button", modifier = Modifier.clickable { setFavorite?.onSetFavorite(property.id) })
                } else {
                    Icon(painter = painterResource(id = R.drawable.fav_filled), contentDescription = "favourite button", modifier = Modifier.clickable { setFavorite?.onSetFavorite(property.id) })
